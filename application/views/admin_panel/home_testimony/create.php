        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card card-outline-primary">
                    ...
                    <div class="card-body">
                        <?php echo form_open_multipart('home_testimony/store'); ?>
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <br>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea style="padding: 10px;" class="col-md-12" rows="5" name="testimony"><?php echo set_value('testimony'); ?></textarea>
                                                </div>
                                            </div>
                                        </div>
