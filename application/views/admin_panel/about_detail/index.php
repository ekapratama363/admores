        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card card-outline-primary">
                    ...
                    <div class="card-body">
                        <?php echo form_open_multipart('about_detail/store'); ?>
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <br>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <img src="<?php echo isset($value->image) ? base_url() . 'uploads/about_detail/' . $value->image : ''; ?>" alt="<?php echo $value->image; ?>">
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="form-actions">
                                ...
                                <a href="<?php echo base_url(); ?>about_detail/index"><button type="button" class="btn btn-inverse">Cancel</button></a>
                            </div>
