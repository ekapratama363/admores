    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="{{ url('user') }}">home_category_project</a></li>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card card-outline-primary">
                    ...
                    <div class="card-body">
                        <?php echo form_open_multipart('home_category_project/update'); ?>
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <br>
                            ...
                            <div class="form-actions">
                                ...
                                <a href="<?php echo base_url(); ?>home_category_project/index"><button type="button" class="btn btn-inverse">Cancel</button></a>
                            </div>
