        ...
        <div class="card">
            <div class="card-body">
                <div class="box-header with-border">
                    <a href="<?php echo base_url(); ?>service_project/create" class="btn btn-primary btn-sm" title="Add User"><i class="fa fa-plus"></i></a>
                </div>
...
<script>
    $(document).ready(function(){
        $('#myTable').dataTable({
            ...
            //"scrollCollapse": true,
            "ajax": {
                "url": "<?php echo base_url(); ?>service_project/ajax_list_service_project",
                "dataType": "json",
                "type": "POST",
                // "data": {
                //     _token: "{{csrf_token()}}",
