    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="{{ url('user') }}">home_service</a></li>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card card-outline-primary">
                    ...
                    <div class="card-body">
                        <?php echo form_open_multipart('home_service/update'); ?>
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <br>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <img src="<?php echo isset($value->image) ? base_url() . 'uploads/home_service/' . $value->image : ''; ?>" width='300px' height='150px' alt="<?php echo $value->image; ?>">
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="form-actions">
                                ...
                                <a href="<?php echo base_url(); ?>home_service/index"><button type="button" class="btn btn-inverse">Cancel</button></a>
                            </div>
