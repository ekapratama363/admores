    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="{{ url('user') }}">about_detail_description</a></li>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card card-outline-primary">
                    ...
                    <div class="card-body">
                        <?php echo form_open_multipart('about_detail_description/update'); ?>
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <br>
                            ...
                            <div class="form-actions">
                                ...
                                <a href="<?php echo base_url(); ?>about_detail_description/index"><button type="button" class="btn btn-inverse">Cancel</button></a>
                            </div>
