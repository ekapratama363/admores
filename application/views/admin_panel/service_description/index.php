        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card card-outline-primary">
                    ...
                    <div class="card-body">
                        <?php echo form_open_multipart('service_description/store'); ?>
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <br>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="title_description" value="<?php echo isset($value->title_description) ? $value->title_description : ''; ?>">
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="form-actions">
                                ...
                                <a href="<?php echo base_url(); ?>service_description/index"><button type="button" class="btn btn-inverse">Cancel</button></a>
                            </div>
