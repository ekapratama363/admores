        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card card-outline-primary">
                    ...
                    <div class="card-body">
                        <?php echo form_open_multipart('about_description/store'); ?>
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <br>
                            ...
                            <div class="form-actions">
                                ...
                                <a href="<?php echo base_url(); ?>about_description/index"><button type="button" class="btn btn-inverse">Cancel</button></a>
                            </div>
