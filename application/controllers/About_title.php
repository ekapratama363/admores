...
class About_title extends CI_Controller {
    ...
    public function __construct()
    {
        ...
        $this->load->model('About_title_model');
    }
    
    public function index()
    {
        $data['value'] = $this->About_title_model->get_about_title();

        $data['page'] = 'about_title/index';
    ...
    public function store()
    {
        ...
        if ($this->form_validation->run() == FALSE){
            ...
            $target_dir = "uploads/about_title/";
